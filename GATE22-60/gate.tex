...
8V_p &= \frac{\frac{1}{j\omega C}}{\sqrt{R^2 + \brak{\frac{1}{j\omega C}}^2}}\cdot 10V_p \\
\frac{64}{100} &= \frac{1}{1 - \omega^2R^2C^2}\\
\omega^2R^2C^2 &= \frac{-9}{16} \\
\omega RC &= \frac{3j}{4} \\
C &= \frac{3j}{4\cdot 50 \cdot 2\pi\cdot 10^3} \\
\implies C &= 2.387j  \mu F
\end{align}
